...
function C = strassenCompute(A, B, nmin)
  ...
  if nargin < 3, nmin = 8;
    ...
    if n <= nmin
      ...
      m = n/2; i = 1:m; j = m+1:n;
      P1 = strassenCompute( A(i,i)+A(j,j), B(i,i)+B(j,j), nmin);
      P2 = strassenCompute( A(j,i)+A(j,j), B(i,i), nmin);
      P3 = strassenCompute( A(i,i), B(i,j)-B(j,j), nmin);
      P4 = strassenCompute( A(j,j), B(j,i)-B(i,i), nmin);
      P5 = strassenCompute( A(i,i)+A(i,j), B(j,j), nmin);
      P6 = strassenCompute( A(j,i)-A(i,i), B(i,i)+B(i,j), nmin);
      P7 = strassenCompute( A(i,j)-A(j,j), B(j,i)+B(j,j), nmin);
